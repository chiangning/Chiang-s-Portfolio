...
export default function Home() {
  return (
    <div className="flex-1 ml-0 md:ml-[33.333333%] lg:ml-80 min-h-screen bg-surface grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 p-1 content-start">
      {/* AI Tile */}
      <motion.div
        initial={{ opacity: 0, scale: 0.98 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.8, delay: 0, ease: [0.25, 0.1, 0.25, 1] }}
        className="relative group overflow-hidden bg-surface-low md:col-span-2 lg:col-span-2"
      >
